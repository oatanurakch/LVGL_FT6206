...
#define FT62XX_NUM_X 0x33 //!< Touch X position 33
#define FT62XX_NUM_Y 0x34 //!< Touch Y position 34

#define FT62XX_REG_MODE 0x00        //!< Device mode, either WORKING or FACTORY
#define FT62XX_REG_CALIBRATE 0x02   //!< Calibrate mode 02
#define FT62XX_REG_WORKMODE 0x00    //!< Work mode 00
